...
<head>
    ...
    <title>Asian Box - Admin : Utilisateur {{ $user->id }}</title>
...
<div class="backgroundContent pb-3">
    ...
    <div class="grid grid-cols-6 gap-4 mb-4">
        <div class="col-start-2 col-span-4">
            <h1 class="titleCustomClass mt-4 text-center"> UTILISATEUR {{ $user->id }} </h1>
        </div>
    </div>
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6">
                                    ...
                                    <input type="text" name="address" id="address" autocomplete="street-address"
                                           placeholder="3 rue Los Santos" value="{{ $user->address }}"
                                           class="mt-1 border-blue-300 focus:border-blue-700 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
